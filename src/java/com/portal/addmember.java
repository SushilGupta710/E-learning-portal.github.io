...
//        step 2 value fetch kerke lao 
        String skill = request.getParameter("memberskill");
        String name = request.getParameter("membername");
        String desc = request.getParameter("memberdesc");

//        for file hum ho Part use kerna pade ga 
        Part filepart = request.getPart("memberimg");
...
//        step 5 using output stream
        ...
        try {
            int status = CourseDAO.SaveMember(cpo);
